...
const OS_DICT = {
  en: {
    ...
    content_link_help: "Use a full https:// URL, #productsSection, #aboutSection, #contactSection, or cart.html. Product slides show the current price and are hidden if the product is archived.",
  ...
  ar: {
    ...
    content_link_help: "استخدم رابط https:// كاملاً أو #productsSection أو #aboutSection أو #contactSection أو cart.html. تعرض شرائح المنتجات السعر الحالي وتختفي عند أرشفة المنتج.",
